...
1. Для хранения различных версий проекта
2. Для возвращения к различным версиям


## 3. Установка VSCode на ваш ПК.

<code>[https://code.visualstudio.com/](VSCode)
</code>

## 4. Установка git на ваш ПК
...
## 5. Что такое репозиторий и инструкция по созданию локальных репозиториев.<br>
