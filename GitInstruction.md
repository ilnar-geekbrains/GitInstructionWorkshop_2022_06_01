...
### Что такое удаленный репозиторий и для чего он нужен
 > репозиторий который находится не на локальной а на удаленной машине ( сервер, GitHub и т.д), служит для удобной работы в проекте из любой точки мира при условии наличия интернета.
