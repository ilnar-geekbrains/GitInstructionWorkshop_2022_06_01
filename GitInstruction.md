...
Начало работы git init (создаёт директории репозитории, папку .git где будет хранится вся история комитов)

git add "... " - Индексация изменений в файле.

git commit -m "..." создаём коммит с коментарием об изминением
