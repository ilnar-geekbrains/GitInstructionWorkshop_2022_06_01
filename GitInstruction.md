...
Сайт-игра для изучения и закрепления знаний по основным командам git и удаленным репозиториям. 

Чтобы перейти на сайт, нажмите на следующую ссылку:
> https://learngitbranching.js.org/?locale=ru_RU

# Git Magic by Ben Lynn
В книге сделан упор на практическое применение, а не на объяснение теоретических подробностей.
