...
Работа с удаленными репозиториями происходит с помощью таких сервисов, как github, gitlab, Bitbucket и др. Они позволяют как выгрузить свой локальный репозиторий в общий доступ, так и скачать чужой репозиторий для работы на локальном ПК. Скачать чужой репозиторий можно без регистрации, имея только ссылку на него. А для выгрузки своего репозитория необходим аккаунт в сервисе git
